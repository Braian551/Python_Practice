...
sin= mt.tan(radian) #aplicacion de la funcion tan
print(f"La tangente de {grad}° es aproximadamente {round(sin,2)}") #Imprimo resultado pero con round para redondearlo a 2 decimales, para evitar algo de impresición