...
descarg_inical = int(input("Ingrese la cantidad de MB iniciales: "))
descarga = int(input("Ingrese la cantidad de MB que se descargan por minuto: "))
borra = int(input("Ingrese la cantidad de MB que se borran por minuto: "))
